...
- **Never mention `.workbuddy/` directory in README or project structure.** This directory is for local WorkBuddy configuration only and should not appear in public documentation or GitHub repository display.
